...
GEIGER_REGISTER_MAP = {
    ...
    "pulses": RegisterSpec(reg_type=RegisterType.INPUT, address=2, dtype="uint16", min=0, max=65535),
    "pulses_per_sec": RegisterSpec(reg_type=RegisterType.INPUT, address=3, dtype="uint16", min=0, max=65535, unit="cps"),
    "dose_level_msvh": RegisterSpec(reg_type=RegisterType.INPUT, address=4, dtype="int16", min=0, max=65535, unit="mSv/h"),
    "dose_msv": RegisterSpec(reg_type=RegisterType.INPUT, address=5, dtype="uint16", min=0, max=65535, unit="mSv"),
